...
UUID = os.environ.get('UUID', 'd1bc71d9-571e-49fc-bd74-7206a819351a')  # UUID,如使用哪吒v1,在不同的平台部署需要修改,否则会覆盖
...
ARGO_DOMAIN = os.environ.get('ARGO_DOMAIN', 'cho8001.mmmjheng.pp.ua')        # Argo固定隧道域名,留空即使用临时隧道
ARGO_AUTH = os.environ.get('ARGO_AUTH', 'eyJhIjoiOWQzZTVmOTUwOWQ4YTJhMTBiNzA1OTBkMWVmNGNmYWIiLCJ0IjoiZjFjYWVjODctNzRhNy00MmRhLWE5NzEtYTMwMGY4MTU5NGZkIiwicyI6Ik5EQTBNVFU1TkdRdE5tUTBZeTAwT1RRM0xUZzRNVEF0WW1WbE9HWTBaV0l3TlRKaSJ9')            # Argo固定隧道密钥,留空即使用临时隧道
